...
function resmap_plugin_row_meta($links, $file) {
    if ($file == plugin_basename(__FILE__)) {
        $documentation_link = '<a target="_blank" href="' . plugin_dir_url(__FILE__) 
                              ...
                              . '</a>';
        $support_link = '<a target="_blank" href="https://hevada.ticksy.com" title="' 
 ...
 */
function resmap_css() {
    wp_enqueue_style('resmap', plugins_url('includes/css/resmap.min.css', __FILE__), false, '4.3');
}
...
function resmap_admin_css($hook) {
    ...
    wp_enqueue_style('resmap_admin', plugins_url('includes/css/resmap.admin.min.css', __FILE__), false, '4.3');
...
function resmap_admin_scripts($hook) {
    ...
    wp_enqueue_script('resmap', plugins_url('includes/js/resmap.min.js', __FILE__), array('jquery', 'googlemapsapi'), '4.3', true);

    // Enqueue admin specific plugin scripts
    wp_enqueue_script('resmap_admin', plugins_url('includes/js/resmap.admin.min.js', __FILE__), array('jquery', 'resmap'), '4.3', true);
