            ...
            <table border="0" cellpadding="5" id="resmap-table">
                ...
                <tr>
                    ...
                    <td>
                     ...
                     <td rowspan="19" valign="top" valign="top" width="600px">
                        ...
                        <a href="<?php echo plugins_url(); ?>/responsive-maps-plugin/documentation/index.html" class="button button-primary button-resmap" target="_blank"><?php echo esc_html__('DOCUMENTATION', 'res_map') ?> </a>
                ...
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <textarea name="iconurl" id="iconurl" rows="2" type='textarea' onblur=""><?php echo plugins_url(); ?>/responsive-maps-plugin/includes/icons/pin.png</textarea>
                        <br>
